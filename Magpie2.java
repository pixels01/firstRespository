	...
	public String getResponse(String statement)
	{
				...
				|| statement.indexOf("teacher") >= 0)
		{
			response = "They sound like a good teacher.";
				...
				|| statement.indexOf("colour") >= 0)
		{
			response = "Is that your favorite color?";
		}
		else if (statement.indexOf("hurt") >= 0
				|| statement.indexOf("hurts") >= 0
				|| statement.indexOf("pain") >= 0)
		{
